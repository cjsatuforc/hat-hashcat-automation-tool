...
def singular_wordlist_ruleset():
    subprocess.call(app + attack_mode_brute_force + hash_type_NetNTLMv2 + hash_path_and_name + pot_file + single_wordlist + rule_set + cmd_defaults, shell=True)
...
def crack_menu_8():
    ...
    global rule_set
    single_wordlist = "/opt/wordlists/rockyou.txt"
    rule_set = " -r /opt/hashcat/rules/best64.rule"
    pot_file()
    hashcat_command_line_menu()
    singular_wordlist_ruleset()
...
def crack_menu_9():
    ...
    global rule_set
    single_wordlist = "/opt/wordlists/rockyou.txt"
    rule_set = " -r /opt/hashcat/rules/d3ad0ne.rule"
    pot_file()
    hashcat_command_line_menu()
    singular_wordlist_ruleset()
...
def crack_menu_10():
    ...
    global rule_set
    single_wordlist = "/opt/wordlists/rockyou.txt"
    rule_set = " -r /opt/hashcat/rules/password_cracking_rules/OneRuleToRuleThemAll.rule"
    pot_file()
    hashcat_command_line_menu()
    singular_wordlist_ruleset()
...
def crack_menu():
    ...
    try:
        while 1:
            ...
            print("8) Rockyou with rule - Best64")
            print("9) Rockyou with rule - d3ad0ne")
            print("10) Rockyou with rule - OneRuleToRuleThemAll")
