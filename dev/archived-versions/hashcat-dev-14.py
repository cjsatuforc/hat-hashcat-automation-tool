...
def crack_menu():
    ...
    try:
        while 1:
            ...
            print("0) Automated Testing - Try all words lists less than <1GB - Common Credentials - includes straight rockyou")
            ...
            print("3) Auto Quick Rule Test - Best64 -> d3ad0ne -> OneRuleToRuleThemAll oscommerce --> rockyou-3000")
            print("4) Automated Testing - Try all words lists 4GB+ - (will take a while to cache each wordlist prior to testing) - Comprehensive Scan")
            print("5) Automated Testing - Try Oxford Dictionary(>=8chars) + Starting with UPPER Case + upto 3 ANY Characters on RIGHT SIDE - Use for Corporate Clients - (Runtime ~4min)")
            print("6) Automated Testing - Try Oxford Dictionary(>=8chars) + Starting with UPPER Case + upto 3 ANY Characters on LEFT SIDE - Use for Corporate Clients - (Runtime ~4min)")
            print("7) Automated Testing - Try Oxford Dictionary Starting with UPPER Case + {upto 4 Numbers LEFT SIDE, upto 4 numbers RIGHT SIDE}")
            print("8) Rockyou with rule - Best64 - (Runtime ~20sec)")
            print("9) Rockyou with rule - d3ad0ne -(Runtime ~1hr 43sec)")
            print("10) Rockyou with rule - OneRuleToRuleThemAll - (Runtime ~2hr 30sec)")
