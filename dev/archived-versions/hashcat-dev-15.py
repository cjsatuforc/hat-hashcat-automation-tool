...
def crack_menu():
    ...
    try:
        while 1:
            ...
            prCyan("0) Automated Testing - Try all words lists less than <1GB - Common Credentials - includes straight rockyou")
            prLightPurple("1) Automated Testing - Try all words lists between 1GB - <4GB")
            prCyan("2) Automated Testing - Try crackstation list (15GB) - (Runtime ~2min 5sec)")
            prLightPurple("3) Auto Quick Rule Test - Best64 -> d3ad0ne -> OneRuleToRuleThemAll oscommerce --> rockyou-3000")
            prCyan("4) Automated Testing - Try all words lists 4GB+ - (will take a while to cache each wordlist prior to testing) - Comprehensive Scan")
            prLightPurple("5) Automated Testing - Try Oxford Dictionary(>=8chars) + Starting with UPPER Case + upto 3 ANY Characters on RIGHT SIDE - Use for Corporate Clients - (Runtime ~4min)")
            prCyan("6) Automated Testing - Try Oxford Dictionary(>=8chars) + Starting with UPPER Case + upto 3 ANY Characters on LEFT SIDE - Use for Corporate Clients - (Runtime ~4min)")
            prLightPurple("7) Automated Testing - Try Oxford Dictionary Starting with UPPER Case + {upto 4 Numbers LEFT SIDE, upto 4 numbers RIGHT SIDE}")
