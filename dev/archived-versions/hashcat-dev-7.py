...
#Crack Menu 11 - Rock you with rule - KoreLogicRules
def crack_menu_11():
    global single_wordlist
    global rule_set_directory
    single_wordlist = " /opt/wordlists/rockyou.txt "
    rule_set_directory = "/opt/wordlists/rules/hashcat-rules/"
    pot_file()
    hashcat_command_line_menu()
    rule_set_walk()
...
def crack_menu():
    ...
    try:
        while 1:
            ...
            print("11) Rock you with rule - KoreLogicRules (Thanks to KoreLogic.com)")
