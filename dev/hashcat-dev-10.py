...
def crack_menu():
    ...
    try:
        while 1:
            ...
            print("5) Automated Testing - Try Oxford Dictionary + Starting with UPPER Case + upto 4 ANY Characters on RIGHT SIDE - Use for Corporate Clients")
            print("6) Automated Testing - Try Oxford Dictionary + Starting with UPPER Case + upto 4 ANY Characters on LEFT SIDE - Use for Corporate Clients")
            ...
            print("12) Rockyou with rule - oscommerce")
